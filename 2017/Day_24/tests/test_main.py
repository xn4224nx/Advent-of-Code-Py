...
def test_bridge_strength_exp01():
    assert BridgeFinder("./data/example_01.txt").bridge_strength((5, 6, 7)) == 31


def test_bridge_strength_exp02():
    assert BridgeFinder("./data/example_01.txt").bridge_strength((0)) == 2


def test_bridge_strength_exp02():
    assert BridgeFinder("./data/example_01.txt").bridge_strength((0, 1, 2, 4)) == 19
