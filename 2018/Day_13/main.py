...
class RailNetwork:
    ...
    def __str__(self):
        """
        Show the current state of the network in a string format.
        """

    def tick(self):
        """
        Move the minecarts one step on the tracks.
        """
        pass

    def first_crash_coord(self) -> (int, int):
        """
        Move the minecarts until two of them colide then return the coordinates
        of the crash.
        """
        pass
