...
PART 2: With these changes, what is the new lowest house number of the house to
...
def find_lowest_house(num_pres: int, elf_lim: bool = False) -> int:
    """
    ...
    for idx in range(1, num_houses):
        if not elf_lim:
            ...
            house_pres[idx : (idx * 50) + 1 : idx] += 11 * idx
...
if __name__ == "__main__":
    ...
    print(f"Part 1 = {find_lowest_house(34000000, True)}")
