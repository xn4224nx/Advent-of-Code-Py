...
def place_in_order(row: int, col: int) -> int:
    """
...
def find_val_at_coord(start_num: int, row: int, col: int) -> int:
    """
    Determine the value at a coordinate of the grid.
    """
    for idx in range(place_in_order(row, col)):
...
if __name__ == "__main__":
    print(f"Part 1 = {find_val_at_coord(20151125, 2981, 3075)}")
