...
PART 2: What is the sum of the fuel requirements for all of the modules on your
...
def module_fuel_req(mass: int, add_fuel: bool = False) -> int:
    """
    How much fuel is required to launch this module into space? Do you need to
    account for the fuel to move fuel?
    """
    if add_fuel:
        total_fuel = 0
        ...
        while True:
            ...
            # You cannot have negative fuel mass
            else:
                break
...
def total_rocket_fuel(module_mass_file: str, account_for_fuel: bool) -> int:
    """
    ...
    with open(module_mass_file, "r") as fp:
        for line in fp.readlines():
            total_fuel += module_fuel_req(int(line), account_for_fuel)
...
if __name__ == "__main__":
    print(
        f"Part 1 = {total_rocket_fuel('./data/input_0.txt', False)}\n"
        f"Part 2 = {total_rocket_fuel('./data/input_0.txt', True)}\n"
    )
