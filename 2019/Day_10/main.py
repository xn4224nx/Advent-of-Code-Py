...
PART 1: Find the best location for a new monitoring station. How many other
...
class AsteroidField:
    ...
    def line_of_sight_num(self, aster_idx: int) -> int:
        """
        For a specific asteroid in the field count the number of other asteroids
        it has a direct line of sight to.
        """
        pass

    def find_max_los(self) -> int:
        """
        Determine the asteroid that has line of sight to the most other
        asteroids and return the number it can see.
        """
        pass
