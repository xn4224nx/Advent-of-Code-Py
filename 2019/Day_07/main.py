...
class Amplifier:
    ...
    def final_output(self, input_value: int) -> int:
        """
    ...
    def run_phase_setting(self, setting: list[int]) -> int:
        """
        What is the final thruster signal value from a specific phase setting?
        """
        pass

    def max_amp_comb(self) -> list[int]:
        """
    ...
    def max_thruster_signal(self) -> int:
        """
        What is the largest thruster value possible from this Amplifier
        controller software?
        """
        pass
